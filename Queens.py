# Description: 運用基因演算法解決八皇后問題的其中一解，
#              並將棋盤結果輸出成 svg 圖片後，儲存到 genetic 資料夾，
#              以及將 fitness 與 generation 的關係圖輸出成 png 圖片後，儲存到 genetic 資料夾，
...
# 儲存圖片
output.save_image_file(file = "fitness", result_dir = "genetic") 
